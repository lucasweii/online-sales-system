...
public:
    METHOD_LIST_BEGIN
        ...
        ADD_METHOD_TO(User::bill, "/bill", Get, "Log", "SessionControl", "RemoveOrders");
    ...
    void newShop(const HttpRequestPtr &req, std::function<void(const HttpResponsePtr &)> &&callback);
    ...
    void bill(const HttpRequestPtr &req, std::function<void(const HttpResponsePtr &)> &&callback);
};
